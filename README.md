...
To create the table databyfield, fieldsbycountry mutst be flipped(like a pivot), the country names must be added as a header after any gaps, commas or parentheses have been removed:
