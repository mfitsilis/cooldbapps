...
2 instances of q are used. Instance one is readonly, allows up to 1 sec execution(somehow this doesn't seem to work?) on port 5900 and processes the queries:<br>
 
    rlwrap ./q/ls32/q loadciafb.q -b -T 1 -p 5900<br>
...
Start the other on port 5901 that will be receiving the messages:
